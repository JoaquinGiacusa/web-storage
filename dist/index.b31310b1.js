...
},{"./components/text":"8YEyP","./components/todo-item":"2MluS","./pages/home":"jrMbi","./state":"28XHA"}],"8YEyP":[function(require,module,exports) {
...
function initHomePage(containerEl) {
    ...
    div.querySelector(".add-button").addEventListener("click", ()=>{
        _state.state.addTask(Math.random(), "Desde el boton");
    });
    /*   const button = document.createElement("button");
  button.textContent = `Agregar item`;
  button.addEventListener("click", () => {}); */ containerEl.appendChild(div);
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["8uBhv","4aleK"], "4aleK", "parcelRequireb883")
